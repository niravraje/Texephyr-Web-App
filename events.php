...
?>
  <div class="templatemo-content-widget white-bg col-2" >
     <form action="editevent.php" method="post">
            ...
            <tr><td>Registration Fees</td><td align="center" style="width:20px">:</td> <td><?php echo $eventFees; ?></td>
            <td style="width:240px"></td>
            <td>  Number Of Rounds</td><td align="center" style="width:20px" >:</td> <td>  <?php echo $eventRoundNumber; ?> </td>
            </tr>

             <tr><td>  Event Head</td><td align="center" style="width:20px">:</td> <td> <?php echo $eventHead ;?></td>
            <td style="width:240px"></td>
             <td>  Number Of Participants </td><td align="center" style="width:20px">:</td> <td><?php echo $eventNumberParticipants; ?></td>
            </tr>


             <tr><td> Phone Number</td><td align="center" style="width:20px">:</td> <td> <?php echo $eventHeadNumber ;?></td>
            <td style="width:240px"></td>
             <td>  Date </td><td align="center" style="width:20px">:</td> <td><?php echo $eventDate; ?></td>
            </tr>

                 <tr><td> </td><td align="center" style="width:20px"></td> <td> </td>
            <td style="width:240px"></td>
             <td> Time </td><td align="center" style="width:20px">:</td> <td><?php echo $eventTime; ?></td>
            </tr>
