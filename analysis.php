...
?>
   ...
   <input type="submit" class="templatemo-blue-button"></input>
        ...
        <tr><td># of Volunteers </td><td align="center" style="width:20px">:</td><td>
          <?php echo $data1['total']; ?></td></tr>

        <tr><td># of Events </td><td align="center" style="width:20px">:</td><td>
          <?php echo $data2['total']; ?></td></tr>

        <tr><td># of Registrations  </td><td align="center" style="width:20px">:</td><td>
          <?php echo $data3['total']; ?></td></tr>

        <tr><td>Amount (Expected)  </td><td align="center" style="width:20px">:</td><td>
          <?php echo $data5['sum']; ?></td></tr>

        <tr><td>Amount (Recieved) </td><td align="center" style="width:20px">:</td><td>
          <?php echo $data6['sum']; ?></td></tr>
        ...
        <br>
          ...
          <div class="templatemo-content-widget white-bg col-2" >
              ...
              <h2 class="templatemo-inline-block">Top 3 volunteers</h2>
              <br><br><h3>
                <table>
        <?php
         while($data7=mysqli_fetch_array($query7))
         {
           ...
           echo "<tr><td> ".$name."</td><td>".$data7['count']."</td></tr>";
         }
         ...
         <div class="templatemo-content-widget white-bg col-2" >
             ...
             <h2 class="templatemo-inline-block">Top 3 colleges</h2>
             <br><br><h3>
               <table>
       <?php
         ...
         while($data8=mysqli_fetch_array($query8))
         {
           ...
           echo "<tr><td> ".$college."</td><td>".$data8['count']."</td></tr>";
         }
        ...
        <div class="templatemo-content-widget white-bg col-2" >
            ...
            <h2 class="templatemo-inline-block">Top 3 events</h2>
            <br><br><h3>
              <table>
      <?php
         ...
         while($data9=mysqli_fetch_array($query9))
         {
           ...
           echo "<tr><td> ".$name."</td><td>".$data9['count']."</td></tr>";
         }
       ?>
