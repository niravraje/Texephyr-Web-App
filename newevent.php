...
<html lang="en">
  ...
  <body>
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
          ...
          <input type="text" name="eventHead" placeholder="Enter the name of the event/workshop head" class="form-control"/>
                </div>
                 <div class="col-lg-6 col-md-6 form-group">
                    <label for="inputLoc">Phone Number</label>
                    <input type="number" name="eventHeadNumber" placeholder="Enter the number of the event/workshop head" class="form-control" />
                </div>
            </div>
  ...
  <div class="row form-group">
    <div class="col-lg-6 col-md-6 form-group">
        ...
        <input type="text" class="form-control" placeholder="Describe the event/workshop here" name="eventDescription"/>
    </div>
  </div>
