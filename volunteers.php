                ...
                <div  class="templatemo-flex-row flex-content-row">
                  <form class="templatemo-search-form" action="" method='post'>
                    <div class="input-group">
                      <input type="text" class="form-control" placeholder="Search Volunteer Name" name="searchterm" id="srch-term">
...
?>
 ...
 <tr><td>Roll No </td><td align="center" style="width:20px">:</td><td><?php echo $roll; ?></td></tr>
 <tr><td>Department </td><td align="center" style="width:20px">:</td><td><?php echo $department; ?></td></tr>
 <tr><td>Email</td><td align="center" style="width:20px">:</td><td><?php echo $email; ?></td></tr>
 </table></h3>
        <br><table><tr><td>
